...
// Answers are only needed until their round resolves (profiling happens then),
// so expire them after 7 days. Without this the collection grows forever under
// the 24/7 bot traffic. Adjust the window by recreating the index.
