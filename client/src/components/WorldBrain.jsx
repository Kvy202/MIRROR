...
// The mirror's surface — a glowing mind at the center of the screen. Every real
// answer fires a synapse toward A (left) or B (right). When the crowd is split
// 50/50 it convulses; on a landslide one side blooms. When a round resolves, a
// surge of pulses storms toward the chosen answer.
//
// Self-contained and imperative: it listens to the socket directly and animates
// on a canvas, keeping the 60fps loop entirely out of React's render cycle.

const NODE_COUNT = 46;
const A_COLOR = [24, 224, 255]; // cyan
const B_COLOR = [255, 107, 157]; // rose
